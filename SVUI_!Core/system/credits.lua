...
|r|cfff81422Failcoder|r |cff2288cc for creating the most awesome UI ever and inspiring the dream
...
local FLAVOR_TITLES = {
  "The Adventures Of...", "The Legend Of...", "They Call Me...", "The Amazing...", "Tales Of...", "The Super Villain...", "The Heroic Expoits Of...", "The Mythic...", "The Villainous...", "The Mysterious..."
};

local FLAVOR_TEXTS = {
  {"%s Of Legend", "The Notorious %s", "Do The %s Dance", "%s: 1, Everyone else: 0", "Chronicles of the %s", "The Mysterious %s", "The Villainous %s"},
  {"Chronicles of the %s %s", "Super %s %s", "The Notorious %s %s", "The Villainous %s %s", "The Hero %s %s", "The Legnadary %s %s", "The Mythic %s %s"}
};
