...
do
	...
	function MOD:UpdateAllReports()
		...
		MOD.ReportGroup5:SetSize(dockWidth/3, dockHeight);
		MOD.ReportGroup6:SetSize(dockWidth/3, dockHeight);
		MOD.ReportGroup7:SetSize(dockWidth/3, dockHeight);
		MOD.ReportGroup8:SetSize(dockWidth/3, dockHeight);
		MOD.ReportGroup9:SetSize(dockWidth/3, dockHeight);
		MOD.ReportGroup10:SetSize(dockWidth/3, dockHeight);
		MOD.ReportGroup11:SetSize(dockWidth/3, dockHeight);
		MOD.ReportGroup12:SetSize(dockWidth/3, dockHeight);
	end
end
...
function MOD:Load()
	...
	---------------------------------------
	local toptopRight = CreateFrame("Frame", "SVUI_ReportsGroup5", SV.Dock.TopCenter)
	toptopRight:SetSize(dockWidth/3, dockHeight)
	toptopRight:SetPoint("TOPRIGHT", SV.Dock.TopCenter, "TOPRIGHT", 0, -25)

	SV:NewAnchor(toptopRight, L["Data Reports 5"])
	self:NewHolder(toptopRight, 1, "ANCHOR_CURSOR", 2)
	
	local toptopLeft = CreateFrame("Frame", "SVUI_ReportsGroup6", SV.Dock.TopCenter)
	toptopLeft:SetSize(dockWidth/3, dockHeight)
	toptopLeft:SetPoint("TOPLEFT", SV.Dock.TopCenter, "TOPLEFT", 0, -25)

	SV:NewAnchor(toptopLeft, L["Data Reports 6"])
	self:NewHolder(toptopLeft, 1, "ANCHOR_CURSOR", 2)
	
	local toptopLeftDou = CreateFrame("Frame", "SVUI_ReportsGroup7", SV.Dock.TopCenter)
	toptopLeftDou:SetSize(dockWidth/3, dockHeight)
	toptopLeftDou:SetPoint("TOPLEFT", SV.Dock.TopCenter, "TOPLEFT", 0, -50)

	SV:NewAnchor(toptopLeftDou, L["Data Reports 7"])
	self:NewHolder(toptopLeftDou, 1, "ANCHOR_CURSOR", 2)
	
	local toptopCenterDuo = CreateFrame("Frame", "SVUI_ReportsGroup8", SV.Dock.TopCenter)
	toptopCenterDuo:SetSize(dockWidth/3, dockHeight)
	toptopCenterDuo:SetPoint("TOP", SV.Dock.TopCenter, "TOP", 0, -50)

	SV:NewAnchor(toptopCenterDuo, L["Data Reports 8"])
	self:NewHolder(toptopCenterDuo, 1, "ANCHOR_CURSOR", 2)
	
	local toptopRightDuo = CreateFrame("Frame", "SVUI_ReportsGroup9", SV.Dock.TopCenter)
	toptopRightDuo:SetSize(dockWidth/3, dockHeight)
	toptopRightDuo:SetPoint("TOPRIGHT", SV.Dock.TopCenter, "TOPRIGHT",0, -50)

	SV:NewAnchor(toptopRightDuo, L["Data Reports 9"])
	self:NewHolder(toptopRightDuo, 1, "ANCHOR_CURSOR", 2)
	
	local toptopLeftSingle = CreateFrame("Frame", "SVUI_ReportsGroup10", SV.Dock.TopCenter)
	toptopLeftSingle:SetSize(dockWidth/3, dockHeight)
	toptopLeftSingle:SetPoint("TOPLEFT", SV.Dock.TopCenter, "TOPLEFT", 0, -100)

	SV:NewAnchor(toptopLeftSingle, L["Data Reports 10"])
	self:NewHolder(toptopLeftSingle, 1, "ANCHOR_CURSOR", 2)
	
	local toptopCenterSingle = CreateFrame("Frame", "SVUI_ReportsGroup11", SV.Dock.TopCenter)
	toptopCenterSingle:SetSize(dockWidth/3, dockHeight)
	toptopCenterSingle:SetPoint("TOP", SV.Dock.TopCenter, "TOP", 0, -100)

	SV:NewAnchor(toptopCenterSingle, L["Data Reports 11"])
	self:NewHolder(toptopCenterSingle, 1, "ANCHOR_CURSOR", 2)
	
	local toptopRightSingle = CreateFrame("Frame", "SVUI_ReportsGroup12", SV.Dock.TopCenter)
	toptopRightSingle:SetSize(dockWidth/3, dockHeight)
	toptopRightSingle:SetPoint("TOPRIGHT", SV.Dock.TopCenter, "TOPRIGHT",0, -100)

	SV:NewAnchor(toptopRightSingle, L["Data Reports 12"])
	self:NewHolder(toptopRightSingle, 1, "ANCHOR_CURSOR", 2)
	...
	self.ReportGroup5 = toptopRight;
	self.ReportGroup6 = toptopLeft;
	self.ReportGroup7 = toptopLeftDou;
	self.ReportGroup8 = toptopCenterDuo;
	self.ReportGroup9 = toptopRightDuo;
	self.ReportGroup10 = toptopLeftSingle;
	self.ReportGroup11 = toptopCenterSingle;
	self.ReportGroup12 = toptopRightSingle;
