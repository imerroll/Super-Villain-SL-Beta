...
oUF_SVUI.Tags.Events["power:curmana"] = "UNIT_POWER_FREQUENT UNIT_MAXPOWER";
...
oUF_SVUI.Tags.Methods["power:curmana"] = function(f)local j = 0 local p = UnitPower(f, j)return p == 0 and" "or SetTagStyle("CURRENT", p, UnitPowerMax(f, j))end
